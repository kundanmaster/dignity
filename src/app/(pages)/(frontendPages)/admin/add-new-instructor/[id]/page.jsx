...
import { updateInstructor } from "../../../../../../utils/api";
...
const getUser = async (id) => {
  try {
    console.log(id);
    const response = await fetch(`/apiRoutes/manage-instructor?id=${id}`); // Send id as query parameter
    if (!response.ok) {
...
const AddNewInstructor = ({ params }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await updateInstructor(instructorId, formData);
