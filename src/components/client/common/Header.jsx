      ...
      <>
        <div className="text-center py-4 bg-goldlight text-white">
          <div className="flex justify-center items-center space-x-8">
            ...
            <a href="tel:+1(888)-404-6348">
              <div className="flex items-center space-x-2 text-white">
                <FaPhoneAlt color="#F27B21" className="" />
                <span>+1(888)-404-6348</span>
              </div>
            </a>
            <a href="tel:+1 (480)-351-2333">
              <div className="flex items-center space-x-2 text-white">
                <FaPhoneAlt color="#F27B21" />
                <span>+1 (480)-351-2333</span>
              </div>
            </a>
            {!user ? (
              <>
            ...
            <div className="flex items-center space-x-6">
              <nav className="relative flex items-center space-x-6 font-semibold text-base">
                <div className="group relative">
                  ...
                  <div className="absolute left-0 p-2 rounded text-nowrap hidden group-hover:block bg-white shadow-lg text-black">
                    <a
                      href="#online"
                ...
                <div className="group relative">
                  ...
                  <div className="absolute text-nowrap p-2 rounded left-0 hidden group-hover:block bg-white shadow-lg text-black">
                    <a
                      href="#aboutus"
                      className="block px-4 py-2 hover:bg-primarygold hover:text-white rounded"
                    >
                ...
                <div className="group relative">
                  ...
                  <div className="absolute left-0 p-2 rounded text-nowrap hidden group-hover:block bg-white shadow-lg text-black">
                    <a href="#" className="block px-2 py-2 hover:bg-primarygold hover:text-white rounded">
                      Arizona
                    </a>
