...
import { FaEnvelope, FaPhoneAlt, FaMapMarkerAlt, FaFacebook, FaInstagram, FaLinkedin, FaTwitter } from 'react-icons/fa';
    ...
    <footer className="bg-gray-800 text-white py-12">
        ...
        <div className="bg-goldlight py-8">
          <div className="max-w-7xl mx-auto text-center">
            <h2 className="text-2xl font-bold mb-4">Join Over Top-notch Care Providers</h2>
            <h2 className="text-2xl font-bold mb-4">Supercharge Your Skills with Dignity Medical Training!</h2>
            <p className="mb-6">
              Join our community of caregivers and healthcare professionals dedicated to continuous learning. Stay informed about new courses, special promotions, and exclusive events tailored to enhance your professional growth.
            </p>
            <div className="flex justify-center mb-6">
              <input 
                type="text" 
                placeholder="First Name" 
                className="p-2 rounded-l border-none focus:ring-0 mr-2 text-black"
                style={{width: '200px'}}
              />
              <input 
                type="email" 
                placeholder="Email Address" 
                className="p-2 border-none focus:ring-0 text-black"
                style={{width: '300px'}}
              />
              <button className="bg-primarygold hover:bg-orange-600 text-white font-semibold py-2 px-4 rounded-r">
                Submit
              </button>
            </div>
            <div className="text-center mt-4">
              <p className="text-lg font-semibold mb-2">Sign Up Now to unlock new opportunities in your career journey!</p>
              <p className="text-lg mb-2">Connect with Dignity Medical Training Today</p>
              <p className="text-lg mb-4">Follow us on social media for updates, tips, and more!</p>
              <div className="flex justify-center space-x-4">
                <a href="https://facebook.com" className="text-white hover:text-blue-700"><FaFacebook size={24} /></a>
                <a href="https://instagram.com" className="text-white hover:text-pink-700"><FaInstagram size={24} /></a>
                <a href="https://linkedin.com" className="text-white hover:text-blue-800"><FaLinkedin size={24} /></a>
                <a href="https://twitter.com" className="text-white hover:text-blue-500"><FaTwitter size={24} /></a>
              </div>
              <p className="text-lg mt-4">Transform your life with Dignity Medical Training. Excellence in education, dedication to your success.</p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto mt-12 grid grid-cols-1 md:grid-cols-4 gap-8 px-4">
          <div>
            <div className="flex items-center mb-4">
              <Image src="/images/pages/whitedignity.png" alt="alt" width={50} height={50} className="mr-2"/> 
              <h3 className="text-xl font-bold">Dignity Medical Training</h3>
            </div>
            <p className="mb-4">Dignity Medical Training is the leading certification and training company in the USA.</p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#allcourse" className="hover:underline">All Courses</a></li>
              <li><a href="#online" className="hover:underline">Online - Self Paced</a></li>
              <li><a href="#online" className="hover:underline">Classroom Courses</a></li>
              <li><a href="#online" className="hover:underline">Zoom Classes</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#aboutus" className="hover:underline">Leadership</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#location" className="hover:underline">Arizona</a></li>
